...
export default function Home() {
  ...
  const item = {
    initial: { opacity: 0, y: prefersReduced ? 0 : 10, scale: 0.99 },
    animate: {
      opacity: 1,
      y: 0,
      scale: 1,
  ...
  return (
    <main className="relative overflow-hidden">
      {/* Dekoracyjne plamy (ciemny/jaśniejszy tryb) */}
      ...
      <section className="container py-10 md:py-12">
        ...
        <motion.div {...fadeUp(0)}>
          ...
          <p className="mt-3 max-w-2xl text-slate-700 dark:text-slate-300">
            ...
            Brak publicznych linków, blokada kopiowania/drukowania (best-effort) oraz wygodne tryby czytania.
          </p>
        ...
        >
          ...
          <motion.div variants={item}>
            <FeatureCard
              ...
              description="Zobacz wszystkie PDF-y powiązane z Twoim kontem."
            />
          </motion.div>
          <motion.div variants={item}>
            <FeatureCard
        ...
        >
          <motion.div variants={item}>
            <SmallCard
              ...
              description="Ciemny, niskie kontrasty, papier — dla wygody oczu."
            />
          </motion.div>
          <motion.div variants={item}>
            <SmallCard
...
function FeatureCard({
  ...
  return (
    <Card className="group relative overflow-hidden transition-all hover:shadow-lg dark:hover:shadow-black/30">
      <Link href={href} className="block p-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 rounded-2xl">
        ...
        <CardContent className="p-0">
          <motion.span
            layoutId="underline"
            className="mt-3 block h-px w-full origin-left scale-x-0 bg-gradient-to-r from-primary/40 to-transparent transition-transform group-hover:scale-x-100"
          />
        </CardContent>
      </Link>
    </Card>
